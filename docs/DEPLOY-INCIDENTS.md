...
| 2026-08-14 19:53 | Materialitzar rollout d'App Hosting | ALT | 1619817b2 | 727bb2520 | BLOCKED_SAFE | Firebase App Hosting no ha acceptat el rollout del commit publicat a prod. | Pendent |
| 2026-08-23 21:51 | Merge i push a prod | ALT | 7a453e64a | 203fed377 | RESOLT | Comprovacio no superada a la fase: Merge i push a prod | Resolt: revisio activa `studio-build-2026-08-23-002` (ready) i endpoint canonical HTTP 200; merge reabsorbit a main (`e75f9cb14`). |
| 2026-08-24 08:35 | Materialitzar rollout d'App Hosting | ALT | 06086f1a2 | cb935c44 | RESOLT | Build fallit: npm ci desincronitzat (buildpack injecta firebase@12.18.0, lock tenia firebase@10) | Resolt actualitzant firebase a ^12.18.0 al projecte (commit 1d360965d); rollout manual del commit 7ff7254d2, revisio activa `studio-build-2026-08-24-004` i endpoint HTTP 200. |
| 2026-08-14 19:53 | Materialitzar rollout d'App Hosting | ALT | 1619817b2 | 727bb2520 | RESOLT | Firebase App Hosting no ha acceptat el rollout del commit publicat a prod. | Obsolet: el commit va quedar substituit per desplegaments posteriors (ultim: build-2026-08-24-004, SUCCEEDED). Sense efecte residual. |
| 2026-09-03 18:57 | Materialitzar rollout d'App Hosting | MITJA | f3e87662f | 2a17650c2 | BLOCKED_SAFE | Firebase App Hosting no ha acceptat el rollout del commit publicat a prod. | Pendent: falta o no és accessible el secret `SUMMA_MCP_STYTCH_PROJECT_SECRET`; cap revisió MCP activa. |
