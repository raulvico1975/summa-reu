...
> = {
  ca: {
    ...
    pricing: {
      ...
      description:
        'Tots els plans inclouen banc, socis, quotes i donacions. Gestió afegeix els documents vinculats i Complet, el tancament i els projectes.',
      priceIntro: 'Plans actuals',
      price: 'des de 49 €',
      priceSuffix: 'al mes',
      note: 'Plans Control 49 €, Gestió 79 € i Complet 119 € al mes.',
      implementation: "La implantació inicial i la migració des d'Excel es valoren segons cada cas.",
      includesTitle: 'Una progressió clara',
      includes: [
        'Control: banc, socis, SEPA, devolucions manuals, certificats i Model 182',
        'Gestió: documents vinculats, control documental, IA assistida i Model 347',
        'Complet: tancament, OCR, projectes, pressupostos i XLSX estructurat',
      ],
  ...
  es: {
    ...
    pricing: {
      ...
      description:
        'Todos los planes incluyen banco, socios, cuotas y donaciones. Gestión añade los documentos vinculados y Completo, el cierre y los proyectos.',
      priceIntro: 'Planes actuales',
      price: 'desde 49 €',
      priceSuffix: 'al mes',
      note: 'Planes Control 49 €, Gestión 79 € y Completo 119 € al mes.',
      implementation: 'La implantación inicial y la migración desde Excel se valoran según cada caso.',
      includesTitle: 'Una progresión clara',
      includes: [
        'Control: banco, socios, SEPA, devoluciones manuales, certificados y Modelo 182',
        'Gestión: documentos vinculados, control documental, IA asistida y Modelo 347',
        'Completo: cierre, OCR, proyectos, presupuestos y XLSX estructurado',
      ],
      cta: 'Pedir una demo',
  ...
  fr: {
    ...
    pricing: {
      ...
      description:
        'Tous les plans incluent banque, membres, cotisations et dons. Gestion ajoute les documents liés et Complet, la clôture et les projets.',
      priceIntro: 'Plans actuels',
      price: 'à partir de 49 €',
      priceSuffix: 'par mois',
      note: 'Plans Contrôle 49 €, Gestion 79 € et Complet 119 € par mois.',
      implementation: 'La mise en place initiale et la migration depuis Excel sont évaluées au cas par cas.',
      includesTitle: 'Une progression claire',
      includes: [
        'Contrôle : banque, membres, SEPA, rejets manuels, certificats et Modèle 182',
        'Gestion : documents liés, contrôle documentaire, IA assistée et Modèle 347',
        'Complet : clôture, OCR, projets, budgets et XLSX structuré',
      ],
  ...
  pt: {
    ...
    pricing: {
      ...
      description:
        'Todos os planos incluem banco, sócios, quotas e doações. Gestão acrescenta documentos ligados e Completo, o fecho e os projetos.',
      priceIntro: 'Planos atuais',
      price: 'desde 49 €',
      priceSuffix: 'por mês',
      note: 'Planos Controlo 49 €, Gestão 79 € e Completo 119 € por mês.',
      implementation: 'A implementação inicial e a migração a partir de Excel são avaliadas caso a caso.',
      includesTitle: 'Uma progressão clara',
      includes: [
        'Controlo: banco, sócios, SEPA, devoluções manuais, certificados e Modelo 182',
        'Gestão: documentos ligados, controlo documental, IA assistida e Modelo 347',
        'Completo: fecho, OCR, projetos, orçamentos e XLSX estruturado',
      ],
      cta: 'Pedir uma demo',
...
> = {
  ca: {
    ...
    conciliationCardDescription:
      'Importa extractes, revisa les propostes de categorització amb IA i relaciona els moviments amb la documentació.',
  ...
  es: {
    ...
    conciliationCardDescription:
      'Importa extractos, revisa las propuestas de categorización con IA y relaciona los movimientos con la documentación.',
  ...
  fr: {
    ...
    conciliationCardDescription:
      'Importez les relevés, vérifiez les propositions de catégorisation par IA et reliez les mouvements à la documentation.',
  ...
  pt: {
    ...
    conciliationCardDescription:
      'Importa extratos, revê as propostas de categorização com IA e relaciona os movimentos com a documentação.',
