...
export const noFallbackRouteRules: Array<{ pattern: RegExp; sections: I18nSection[] }> = [
  { pattern: /^\/$/, sections: ["home", "nav"] },
  { pattern: /^\/login\/?$/, sections: ["login", "nav", "errors"] },
  { pattern: /^\/signup\/?$/, sections: ["signup", "nav", "errors"] },
  { pattern: /^\/dashboard\/?$/, sections: ["dashboard", "status", "nav", "errors"] },
  { pattern: /^\/polls\/new\/?$/, sections: ["poll", "meeting", "nav", "errors"] },
  { pattern: /^\/polls\/[^/]+\/?$/, sections: ["poll", "status", "nav", "errors"] },
  { pattern: /^\/meetings\/[^/]+\/?$/, sections: ["meeting", "status", "nav", "errors"] },
